...
class EyeColorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.eyeColors.index', compact('eyeColors'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.eyeColors.create');
    }
    ...
    public function store(StoreEyeColorRequest $request)
    {
        ...
        return redirect()->route('admin.eye-colors.index');
    }
    ...
    public function edit(EyeColor $eyeColor)
    {
        ...
        return view('admin.eyeColors.edit', compact('eyeColor'));
    }
    ...
    public function show(EyeColor $eyeColor)
    {
        ...
        return view('admin.eyeColors.show', compact('eyeColor'));
    }
