...
class MouthShapeController extends Controller
{
    public function index()
    {
        ...
        return view('admin.mouthShapes.index', compact('mouthShapes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.mouthShapes.create');
    }
    ...
    public function store(StoreMouthShapeRequest $request)
    {
        ...
        return redirect()->route('admin.mouth-shapes.index');
    }
    ...
    public function edit(MouthShape $mouthShape)
    {
        ...
        return view('admin.mouthShapes.edit', compact('mouthShape'));
    }
    ...
    public function show(MouthShape $mouthShape)
    {
        ...
        return view('admin.mouthShapes.show', compact('mouthShape'));
    }
