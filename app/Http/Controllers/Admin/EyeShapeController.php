...
class EyeShapeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.eyeShapes.index', compact('eyeShapes'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.eyeShapes.create');
    }
    ...
    public function store(StoreEyeShapeRequest $request)
    {
        ...
        return redirect()->route('admin.eye-shapes.index');
    }
    ...
    public function edit(EyeShape $eyeShape)
    {
        ...
        return view('admin.eyeShapes.edit', compact('eyeShape'));
    }
    ...
    public function show(EyeShape $eyeShape)
    {
        ...
        return view('admin.eyeShapes.show', compact('eyeShape'));
    }
