...
class FacialExpressionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.facialExpressions.index', compact('facialExpressions'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.facialExpressions.create');
    }
    ...
    public function store(StoreFacialExpressionRequest $request)
    {
        ...
        return redirect()->route('admin.facial-expressions.index');
    }
    ...
    public function edit(FacialExpression $facialExpression)
    {
        ...
        return view('admin.facialExpressions.edit', compact('facialExpression'));
    }
    ...
    public function show(FacialExpression $facialExpression)
    {
        ...
        return view('admin.facialExpressions.show', compact('facialExpression'));
    }
