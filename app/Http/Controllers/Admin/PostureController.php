...
class PostureController extends Controller
{
    public function index()
    {
        ...
        return view('admin.postures.index', compact('postures'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.postures.create');
    }
    ...
    public function store(StorePostureRequest $request)
    {
        ...
        return redirect()->route('admin.postures.index');
    }
    ...
    public function edit(Posture $posture)
    {
        ...
        return view('admin.postures.edit', compact('posture'));
    }
    ...
    public function show(Posture $posture)
    {
        ...
        return view('admin.postures.show', compact('posture'));
    }
