...
class HairLengthController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.hairLengths.index', compact('hairLengths'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.hairLengths.create');
    }
    ...
    public function store(StoreHairLengthRequest $request)
    {
        ...
        return redirect()->route('frontend.hair-lengths.index');
    }
    ...
    public function edit(HairLength $hairLength)
    {
        ...
        return view('frontend.hairLengths.edit', compact('hairLength'));
    }
    ...
    public function show(HairLength $hairLength)
    {
        ...
        return view('frontend.hairLengths.show', compact('hairLength'));
    }
