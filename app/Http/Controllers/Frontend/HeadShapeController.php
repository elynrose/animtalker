...
class HeadShapeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.headShapes.index', compact('headShapes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.headShapes.create');
    }
    ...
    public function store(StoreHeadShapeRequest $request)
    {
        ...
        return redirect()->route('frontend.head-shapes.index');
    }
    ...
    public function edit(HeadShape $headShape)
    {
        ...
        return view('frontend.headShapes.edit', compact('headShape'));
    }
    ...
    public function show(HeadShape $headShape)
    {
        ...
        return view('frontend.headShapes.show', compact('headShape'));
    }
