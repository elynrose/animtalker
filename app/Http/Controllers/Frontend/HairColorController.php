...
class HairColorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.hairColors.index', compact('hairColors'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.hairColors.create');
    }
    ...
    public function store(StoreHairColorRequest $request)
    {
        ...
        return redirect()->route('frontend.hair-colors.index');
    }
    ...
    public function edit(HairColor $hairColor)
    {
        ...
        return view('frontend.hairColors.edit', compact('hairColor'));
    }
    ...
    public function show(HairColor $hairColor)
    {
        ...
        return view('frontend.hairColors.show', compact('hairColor'));
    }
