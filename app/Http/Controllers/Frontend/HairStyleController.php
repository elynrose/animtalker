...
class HairStyleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.hairStyles.index', compact('hairStyles'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.hairStyles.create');
    }
    ...
    public function store(StoreHairStyleRequest $request)
    {
        ...
        return redirect()->route('frontend.hair-styles.index');
    }
    ...
    public function edit(HairStyle $hairStyle)
    {
        ...
        return view('frontend.hairStyles.edit', compact('hairStyle'));
    }
    ...
    public function show(HairStyle $hairStyle)
    {
        ...
        return view('frontend.hairStyles.show', compact('hairStyle'));
    }
