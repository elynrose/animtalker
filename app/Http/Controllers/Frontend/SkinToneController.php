...
class SkinToneController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.skinTones.index', compact('skinTones'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.skinTones.create');
    }
    ...
    public function store(StoreSkinToneRequest $request)
    {
        ...
        return redirect()->route('frontend.skin-tones.index');
    }
    ...
    public function edit(SkinTone $skinTone)
    {
        ...
        return view('frontend.skinTones.edit', compact('skinTone'));
    }
    ...
    public function show(SkinTone $skinTone)
    {
        ...
        return view('frontend.skinTones.show', compact('skinTone'));
    }
