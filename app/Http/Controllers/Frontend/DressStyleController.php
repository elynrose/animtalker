...
class DressStyleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.dressStyles.index', compact('dressStyles'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.dressStyles.create');
    }
    ...
    public function store(StoreDressStyleRequest $request)
    {
        ...
        return redirect()->route('frontend.dress-styles.index');
    }
    ...
    public function edit(DressStyle $dressStyle)
    {
        ...
        return view('frontend.dressStyles.edit', compact('dressStyle'));
    }
    ...
    public function show(DressStyle $dressStyle)
    {
        ...
        return view('frontend.dressStyles.show', compact('dressStyle'));
    }
