...
class EmotionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.emotions.index', compact('emotions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.emotions.create');
    }
    ...
    public function store(StoreEmotionRequest $request)
    {
        ...
        return redirect()->route('frontend.emotions.index');
    }
    ...
    public function edit(Emotion $emotion)
    {
        ...
        return view('frontend.emotions.edit', compact('emotion'));
    }
    ...
    public function show(Emotion $emotion)
    {
        ...
        return view('frontend.emotions.show', compact('emotion'));
    }
