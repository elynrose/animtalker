...
class NoseShapeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.noseShapes.index', compact('noseShapes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.noseShapes.create');
    }
    ...
    public function store(StoreNoseShapeRequest $request)
    {
        ...
        return redirect()->route('frontend.nose-shapes.index');
    }
    ...
    public function edit(NoseShape $noseShape)
    {
        ...
        return view('frontend.noseShapes.edit', compact('noseShape'));
    }
    ...
    public function show(NoseShape $noseShape)
    {
        ...
        return view('frontend.noseShapes.show', compact('noseShape'));
    }
