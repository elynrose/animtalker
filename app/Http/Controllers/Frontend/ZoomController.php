...
class ZoomController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.zooms.index', compact('zooms'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.zooms.create');
    }
    ...
    public function store(StoreZoomRequest $request)
    {
        ...
        return redirect()->route('frontend.zooms.index');
    }
    ...
    public function edit(Zoom $zoom)
    {
        ...
        return view('frontend.zooms.edit', compact('zoom'));
    }
    ...
    public function show(Zoom $zoom)
    {
        ...
        return view('frontend.zooms.show', compact('zoom'));
    }
