...
class AgeGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.ageGroups.index', compact('ageGroups'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.ageGroups.create');
    }
    ...
    public function store(StoreAgeGroupRequest $request)
    {
        ...
        return redirect()->route('frontend.age-groups.index');
    }
    ...
    public function edit(AgeGroup $ageGroup)
    {
        ...
        return view('frontend.ageGroups.edit', compact('ageGroup'));
    }
    ...
    public function show(AgeGroup $ageGroup)
    {
        ...
        return view('frontend.ageGroups.show', compact('ageGroup'));
    }
