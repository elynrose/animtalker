    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.characters.update", [$character->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.character.fields.name') }}</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $character->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="gender_id" id="gender_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="hair_color_id" id="hair_color_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="hair_lenght_id" id="hair_lenght_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="hair_style_id" id="hair_style_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="head_shape_id" id="head_shape_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="nose_shape_id" id="nose_shape_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="mouth_shape_id" id="mouth_shape_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="eye_shape_id" id="eye_shape_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="eye_color_id" id="eye_color_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="skin_tone_id" id="skin_tone_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="facial_expression_id" id="facial_expression_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="emotion_id" id="emotion_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="dress_style_id" id="dress_style_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="dress_colors[]" id="dress_colors" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="props[]" id="props" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="posture_id" id="posture_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="character_zoom_id" id="character_zoom_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="caption" id="caption" value="{{ old('caption', $character->caption) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="custom_prompt" id="custom_prompt">{{ old('custom_prompt', $character->custom_prompt) }}</textarea>
...
<script>
    ...
    url: '{{ route('frontend.characters.storeMedia') }}',
    maxFilesize: 2, // MB
