    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.skin-tones.update", [$skinTone->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="tone">{{ trans('cruds.skinTone.fields.tone') }}</label>
                            <input class="form-control" type="text" name="tone" id="tone" value="{{ old('tone', $skinTone->tone) }}">
                            @if($errors->has('tone'))
