        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.skinTone.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.skin-tones.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="tone">{{ trans('cruds.skinTone.fields.tone') }}</label>
                            <input class="form-control" type="text" name="tone" id="tone" value="{{ old('tone', '') }}">
                            @if($errors->has('tone'))
...
<script>
    ...
    url: '{{ route('frontend.skin-tones.storeMedia') }}',
    maxFilesize: 2, // MB
