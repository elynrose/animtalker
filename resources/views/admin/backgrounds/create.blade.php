...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.background.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.backgrounds.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="background_title">{{ trans('cruds.background.fields.background_title') }}</label>
                <input class="form-control {{ $errors->has('background_title') ? 'is-invalid' : '' }}" type="text" name="background_title" id="background_title" value="{{ old('background_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('scene') ? 'is-invalid' : '' }}" name="scene" id="scene" required>{{ old('scene') }}</textarea>
                @if($errors->has('scene'))
                    <div class="invalid-feedback">
                        {{ $errors->first('scene') }}
                    </div>
